import random
import copy
# provided by Oles Dobosevych on the consultation


def generate_winning_combinations():
    """
    :return: list with winning combinations.
    """
    combinations = []
    for i in range(3):
        combination1 = []
...
class Board:
    """
    Class that represents board for tic-tac-toe game.
    """
    NOUGHT = 1
    CROSS = -1
    EMPTY = 0
    ...
    def make_move(self, cell):
        """
        :return: bool whether step(by user) was made.
        """
    ...
    def has_winner(self):
        """
        :return: whether it has a winner = appropriate integer.
        """
    ...
    def make_random_move(self):
        """
        :return: bool whether random step was made.
        """
        possible_moves = []
        for i in range(3):
            for j in range(3):
    ...
    def compute_score(self):
        """
        :return: sum of all scores in binary tree(with recurse) from left side to right.
        """
    ...
    def __str__(self):
        """
        :return: the board in decorated way.
        """
        transform = {0: " ", 1: "O", -1: "X"}
